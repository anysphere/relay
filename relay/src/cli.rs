...
pub fn extract_config_args(matches: &ArgMatches) -> OverridableConfig {
    ...
    OverridableConfig {
        ...
        metrics_statsd: None,
        metrics_statsd_buffer_size: None,
        metrics_prefix: None,
        metrics_default_tags: None,
        metrics_hostname_tag: None,
        metrics_periodic_secs: None,
        fanout_enabled: None,
        fanout_url: None,
...
pub fn extract_config_env_vars() -> OverridableConfig {
    OverridableConfig {
        ...
        metrics_statsd: env::var("RELAY_METRICS_STATSD").ok(),
        metrics_statsd_buffer_size: env::var("RELAY_METRICS_STATSD_BUFFER_SIZE").ok(),
        metrics_prefix: env::var("RELAY_METRICS_PREFIX").ok(),
        metrics_default_tags: env::var("RELAY_METRICS_DEFAULT_TAGS").ok(),
        metrics_hostname_tag: env::var("RELAY_METRICS_HOSTNAME_TAG").ok(),
        metrics_periodic_secs: env::var("RELAY_METRICS_PERIODIC_SECS").ok(),
